...
│   │   ├── utils/           # Seeding, correction, and helper scripts
...
### Step 1: Clone and Clean Remotes (For Contributor Teams)
Ensure your Git remotes are pointing directly to the main repository:
```bash
# Check current remotes
git remote -v

# Clean extraneous remotes if necessary
git remote remove final
git remote remove origin
git remote rename deploy-target origin
```
